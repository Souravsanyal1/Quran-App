                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _LoginTheme.emerald.withValues(alpha: 0.1),
                      shape: BoxShape.circle,
                      border: Border.all(
                          color: _LoginTheme.gold.withValues(alpha: 0.5),
                          width: 1.5),
                    ),
                    child: const Icon(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(
                            color: _LoginTheme.emerald.withValues(alpha: 0.2)),
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(16),
                        borderSide: const BorderSide(
                            color: _LoginTheme.emerald, width: 1.5),
                      ),
                    ),
                  ),
                  ...
                  Obx(() => TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                            ...
                            borderSide: BorderSide(
                                color:
                                    _LoginTheme.emerald.withValues(alpha: 0.2)),
                          ),
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16),
                            borderSide: const BorderSide(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              ...
                              side: const BorderSide(
                                  color: _LoginTheme.gold, width: 0.5),
                            ),
                            elevation: 0,
                          ),
                  ...
                  TextButton.icon(
                    ...
                    icon: const Icon(Icons.arrow_back_rounded,
                        color: _LoginTheme.gold, size: 18),
                    label: Text(
                      'Back to App',
                      style: GoogleFonts.poppins(
                        color: _LoginTheme.gold,
