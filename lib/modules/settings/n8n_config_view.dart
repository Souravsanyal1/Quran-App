...
class N8nConfigView extends GetView<N8nConfigController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final scaffoldBg = isDark ? _N8nTheme.darkSurface : _N8nTheme.lightSurface;
      ...
      final borderColor = isDark ? _N8nTheme.emerald.withOpacity(0.15) : _N8nTheme.emerald.withOpacity(0.06);
            ...
            flexibleSpace: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [_N8nTheme.emeraldDark, _N8nTheme.emerald, _N8nTheme.emeraldLight],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
                border: Border(bottom: BorderSide(color: _N8nTheme.gold, width: 1.5)),
              ),
            ),
            title: Text(
              ...
              onPressed: () async {
                ...
                if (success) {
                  Get.snackbar(
                    ...
                    backgroundColor: _N8nTheme.emerald.withOpacity(0.92),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _N8nTheme.emerald.withOpacity(isDark ? 0.08 : 0.05),
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: _N8nTheme.gold.withOpacity(0.3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Icon(Icons.info_outline_rounded, color: _N8nTheme.gold, size: 22),
                ...
                _buildSectionHeader(bn ? 'এন্ডপয়েন্ট কনফিগারেশন' : 'Endpoint Configuration'),
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(() => SwitchListTile(
                            ...
                            title: Text(
                              bn ? 'মডেল কনটেক্সট প্রোটোকল (MCP) প্রোটোকল' : 'Model Context Protocol (MCP) Mode',
                              style: GoogleFonts.poppins(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                                color: textColor,
                      ...
                      Obx(() {
                        if (!controller.useMcp.value) return const SizedBox.shrink();
                        return Padding(
                          padding: const EdgeInsets.only(top: 16.0),
                          child: _buildTextField(
                            controller: controller.toolNameController,
                            label: bn ? 'টুল নাম (MCP Tool Name)' : 'MCP Tool Name',
                            hint: 'chat',
                ...
                _buildSectionHeader(bn ? 'কানেকশন টেস্ট কনসোল' : 'Connection Testing Console'),
                const SizedBox(height: 12),
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildTextField(
                        ...
                        hint: bn ? 'যেমন: আসসালামু আলাইকুম' : 'e.g. Hello, who are you?',
                      ...
                      Obx(() => ElevatedButton.icon(
                            ...
                            icon: controller.isTesting.value
                                ...
                                : const Icon(Icons.bolt_rounded, color: _N8nTheme.gold),
                            label: Text(
                              controller.isTesting.value
                                  ? (bn ? 'পরীক্ষা করা হচ্ছে...' : 'Testing...')
                                  : (bn ? 'কানেকশন পরীক্ষা করুন' : 'Test Connection'),
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isDark ? _N8nTheme.darkSurface : Colors.grey.shade100,
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.poppins(
                                  color: isSuccess ? textColor : Colors.redAccent,
                                  fontSize: 13.5,
                                  height: 1.4,
                                ),
                              ),
                            ...
                            Theme(
                              ...
                              child: ExpansionTile(
                                ...
                                title: Text(
                                  ...
                                  style: GoogleFonts.poppins(fontSize: 13, color: subtitleColor, fontWeight: FontWeight.w600),
                                ),
                                children: [
                                  Container(
                                    width: double.infinity,
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: GoogleFonts.poppins(color: textColor.withOpacity(0.4), fontSize: 13),
