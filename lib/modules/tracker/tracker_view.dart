...
class TrackerView extends GetView<TrackerController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Scaffold(
        backgroundColor: isDark ? _TrackerTheme.darkSurface : _TrackerTheme.lightSurface,
        appBar: AppBar(
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [_TrackerTheme.emeraldDark, _TrackerTheme.emerald, _TrackerTheme.emeraldLight],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              border: Border(bottom: BorderSide(color: _TrackerTheme.gold, width: 1.5)),
            ),
            child: Stack(
              fit: StackFit.expand,
              children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [_TrackerTheme.emeraldDark, _TrackerTheme.emerald],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                    borderRadius: BorderRadius.circular(24),
                    border: Border.all(color: _TrackerTheme.gold.withOpacity(0.5), width: 1.5),
                    boxShadow: [
                      BoxShadow(
                        color: _TrackerTheme.emerald.withOpacity(0.2),
                        blurRadius: 10,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: GoogleFonts.poppins(color: _TrackerTheme.goldSoft, fontSize: 13, fontWeight: FontWeight.w500),
                            ),
                          ],
                        ),
                      ),
                ...
                ...controller.todayRecords.keys.map((activity) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: isDark ? _TrackerTheme.darkCard : _TrackerTheme.lightCard,
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(
                        color: isDone
                            ? _TrackerTheme.emerald
                            : (isDark ? _TrackerTheme.emerald.withOpacity(0.15) : _TrackerTheme.emerald.withOpacity(0.06)),
                        width: isDone ? 1.5 : 1,
                      ),
                    ),
                    child: CheckboxListTile(
                      ...
                      secondary: Icon(
                        activity == 'Quran' ? Icons.menu_book_rounded : Icons.nights_stay_outlined,
