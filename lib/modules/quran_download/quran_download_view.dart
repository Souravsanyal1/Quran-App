...
class QuranDownloadView extends GetView<QuranDownloadController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Scaffold(
        backgroundColor:
            isDark ? _DownloadTheme.darkSurface : _DownloadTheme.lightSurface,
        appBar: AppBar(
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  _DownloadTheme.emeraldDark,
                  _DownloadTheme.emerald,
                  _DownloadTheme.emeraldLight
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              border: Border(
                  bottom: BorderSide(color: _DownloadTheme.gold, width: 1.5)),
            ),
            child: Stack(
              fit: StackFit.expand,
              children: [
          ...
          if (controller.isLoading.value) {
            return Center(
              child: PercentageLoadingWidget(
                message:
                    isBn ? 'সূরা তালিকা লোড হচ্ছে...' : 'Loading Surah List...',
              ),
            );
          }
          ...
          return Column(
            children: [
              Padding(
                ...
                child: Card(
                  color: isDark
                      ? _DownloadTheme.darkCard
                      : _DownloadTheme.lightCard,
                  elevation: 0,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(16),
                    side: BorderSide(
                      color: isDark
                          ? _DownloadTheme.emerald.withValues(alpha: 0.15)
                          : _DownloadTheme.emerald.withValues(alpha: 0.06),
                      width: 1,
                    ),
                  ),
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.info_outline_rounded,
                            color: _DownloadTheme.emerald, size: 28),
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(() {
                      final state =
                          controller.downloadStates[surah.number] ?? 0;
                          ...
                          leading: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isDark
                                  ...
                                  : _DownloadTheme.goldSoft,
                              shape: BoxShape.circle,
                              border: Border.all(
                                  color: _DownloadTheme.gold, width: 1.5),
                            ),
                            child: Text(
