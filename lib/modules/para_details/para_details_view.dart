...
class ParaDetailsView extends GetView<ParaDetailsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Scaffold(
        backgroundColor:
            isDark ? _ParaTheme.darkSurface : _ParaTheme.lightSurface,
        appBar: AppBar(
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  _ParaTheme.emeraldDark,
                  _ParaTheme.emerald,
                  _ParaTheme.emeraldLight
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              border: Border(
                  bottom: BorderSide(color: _ParaTheme.gold, width: 1.5)),
            ),
            child: Stack(
              fit: StackFit.expand,
              children: [
          ...
          actions: [
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                ...
                if (value == 'autoplay')
                  controller.setAutoPlay(!controller.autoPlayNext.value);
              },
              itemBuilder: (context) => [
                PopupMenuItem(
                  value: 'autoplay',
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor: _ParaTheme.emerald,
                        foregroundColor: Colors.white),
                    child:
                        Text(settings.isBangla ? 'আবার চেষ্টা করুন' : 'Retry'),
                  ),
                ],
              ),
            );
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(() {
                      final isCurrentPlaying =
                          controller.playingAyahNumber.value == ayah.number;
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: isCurrentPlaying
                              ...
                              : (isDark
                                  ? _ParaTheme.darkCard
                                  : _ParaTheme.lightCard),
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: isCurrentPlaying
                                ? _ParaTheme.emerald.withValues(alpha: 0.5)
                                : (isDark
                                    ? _ParaTheme.emerald.withValues(alpha: 0.12)
                                    : _ParaTheme.emerald
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      icon: Icon(
                                          ...
                                          color: _ParaTheme.emerald),
                                      onPressed: () =>
                                          controller.toggleBookmark(ayah),
                                    ),
                                    IconButton(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border(
                          top: BorderSide(
                              color:
                                  _ParaTheme.emerald.withValues(alpha: 0.1))),
                    ),
                    child: SafeArea(
                      top: false,
                      child: Row(
  ...
  Widget _buildHeaderCard(SettingsController settings) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: _ParaTheme.gold.withValues(alpha: 0.5), width: 1.5),
        boxShadow: [
          BoxShadow(
            color: _ParaTheme.emerald.withValues(alpha: 0.2),
            blurRadius: 12,
            offset: const Offset(0, 4),
          )
        ],
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildHeaderStatItem(settings.isBangla ? 'মোট আয়াত' : 'Ayahs',
  ...
  Widget _buildHeaderStatItem(String label, String value) {
    return Column(
      children: [
        ...
        const SizedBox(height: 4),
        Text(label,
            style: const TextStyle(color: _ParaTheme.goldSoft, fontSize: 12)),
      ],
    );
  }
}
