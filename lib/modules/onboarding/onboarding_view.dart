    ...
    return Scaffold(
      body: IntroductionScreen(
        pages: controller.slides.map((slide) {
          return PageViewModel(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [_OnboardingTheme.emerald, _OnboardingTheme.emeraldLight],
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: _OnboardingTheme.emerald.withOpacity(0.3),
                      blurRadius: 20,
                      spreadRadius: 5,
                    ),
                  ],
            ...
            decoration: PageDecoration(
              ...
              pageColor: isDark ? _OnboardingTheme.darkBg : _OnboardingTheme.lightBg,
        ...
        skip: Text(
          ...
          style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: _OnboardingTheme.gold),
        ),
        next: const Icon(Icons.arrow_forward_rounded, color: _OnboardingTheme.emerald),
        done: Text(
          isBn ? 'শুরু করুন' : 'Get Started', 
          style: GoogleFonts.poppins(fontWeight: FontWeight.w700, color: _OnboardingTheme.emerald),
        ),
